...
有关 MistralAI 组件使用的 MistralAI 功能和功能的更多信息，请参阅 [MistralAI 文档](https://docs.mistral.ai)。
...
许多 **MistralAI** 组件输入参数在可视化编辑器中默认为隐藏状态。
...
许多 **MistralAI Embeddings** 组件输入参数在可视化编辑器中默认为隐藏状态。
您可以通过[组件标题菜单](/concepts-components#component-menus)中的 <Icon name="SlidersHorizontal" aria-hidden="true"/> **控件** 来切换参数。
